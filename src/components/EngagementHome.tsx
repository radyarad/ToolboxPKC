          ...
          <CardTitle>
            <div className="flex items-center justify-between">
              ...
              <div className="h-8 w-8 sm:h-10 sm:w-10 lg:h-12 lg:w-12 bg-blue-100 rounded-lg flex items-center justify-center">
                <FolderCheck className="h-4 w-4 sm:h-5 sm:w-5 lg:h-6 lg:w-6 text-blue-600" />
              </div>
            </div>
          </CardTitle>
          <CardDescription>
            <div className="mt-2 sm:mt-4 flex items-center">
              ...
              <span className="text-xs sm:text-sm text-green-600 dark:text-green-300">
                +12% dari minggu lalu
              </span>
            </div>
          </CardDescription>
      ...
      <Card>
        <CardHeader className="p-3 sm:p-4 lg:p-6">
          <CardTitle>
            <div className="flex items-center justify-between">
              <div className="space-y-1">
                <p className="text-xs sm:text-sm font-medium">Task Selesai</p>
      ...
      <Card>
        <CardHeader className="p-3 sm:p-4 lg:p-6">
          <CardTitle>
            <div className="flex items-center justify-between">
              <div className="space-y-1">
                <p className="text-xs sm:text-sm font-medium">Pending Task</p>
          ...
          <CardDescription>
            <div className="mt-2 sm:mt-4 flex items-center">
              <AlertCircle className="h-3 w-3 sm:h-4 sm:w-4 text-red-500 dark:text-red-300 mr-1" />
        ...
        <CardHeader className="p-3 sm:p-4 lg:p-6">
          <CardTitle>
            <div className="flex items-center justify-between">
              ...
              <div className="h-8 w-8 sm:h-10 sm:w-10 lg:h-12 lg:w-12 bg-purple-100 rounded-lg flex items-center justify-center">
          ...
          <CardDescription>
            <div className="mt-2 sm:mt-4 flex items-center">
              <TriangleAlert className="h-3 w-3 sm:h-4 sm:w-4 text-yellow-500 dark:text-yellow-300 mr-1" />
      ...
      <Card>
        <CardHeader className="p-3 sm:p-4 lg:p-6">
          <CardTitle>
            <div className="flex items-center justify-between">
              <div className="space-y-1">
                <p className="text-xs sm:text-sm font-medium">Notulensi</p>
                <p className="text-xl sm:text-2xl font-bold">23</p>
              </div>
              <div className="h-8 w-8 sm:h-10 sm:w-10 lg:h-12 lg:w-12 bg-blue-100 rounded-lg flex items-center justify-center">
                <NotepadText className="h-4 w-4 sm:h-5 sm:w-5 lg:h-6 lg:w-6 text-blue-600" />
              </div>
            </div>
          </CardTitle>
          <CardDescription>
